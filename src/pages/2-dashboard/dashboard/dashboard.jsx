...
const Dashboard = ({ className }) => {
  ...
  useLayoutEffect(() => {
    let howToPlay = JSON.parse(localStorage.getItem('howToPlay'))
    if (!howToPlay) {
      setOpen(true)
        ...
        <div className='space-y-3'>
          ...
          <div className='overflow-hidden relative'>
            ...
            <div style={{scrollBehavior: 'smooth'}} className='flex items-center gap-4 pr-4 overflow-auto py-3 no-scrollbar bg-black bg-opacity-5'>
              ...
              <div onClick={() => setOpen(true)} className='inline-flex flex-col justify-center items-center font-semibold cursor-pointer p-4 rounded-2xl bg-yellow-100 hover:opacity-80 text-yellow-500 hover:text-yellow-500 no-underline hover:no-underline capitalize w-28 h-28  space-y-2 flex-shrink-0 text-center curly'>
                <FaQuestion size={16} className='flex-1' />
                <div className='flex-1'>How To Earn Points</div>
              </div>
