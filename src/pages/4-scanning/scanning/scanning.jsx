    ...
    <Switch>
      <Route exact path='/app/scanning'>
        <div className={`${className} flex-1 flex flex-col text-gray-800 bg-green-50`}>
          ...
          <FadeIn className='p-4 py-8 text-center bg-white'>
            Please scan receipts that contains flour mills products
          </FadeIn>
          ...
          <div className='space-y-4 p-4 pt-6 pb-12 bg-white rounded-t-3xl text-center'>
            ...
            <div className='font-medium text-gray-400 text-base'>Scanning the bill.. Hold steady</div>
            <div onClick={() => history.push('/app/scan-history')} className='border border-green-100 text-green_dark font-semibold px-6 py-4 text-center rounded-xl cursor-pointer'>Stop scan</div>
          </div>
